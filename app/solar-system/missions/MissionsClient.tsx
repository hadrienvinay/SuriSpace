...
// ── Types ─────────────────────────────────────────────────────
type BodyStub = { id: string; nameFr: string; color: string; emoji: string };
    ...
    <>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          ...
          { label: 'Agences',      count: agencyCount,   color: '#60A5FA', icon: '🏛️' },
          { label: 'Destinations', count: bodies.length, color: '#F472B6', icon: '🎯' },
        ].map(s => (
