...
const stops: Stop[] = [
  { expo: -35, val: '1,6 × 10⁻³⁵ m', name: 'Longueur de Planck', meters: '1.6 × 10⁻³⁵ m', Icon: PlanckIcon, domain: 'quantum', domainLabel: 'Quantique',
    desc: "La plus petite longueur ayant un sens physique connu. En deçà, l'espace continu tel que le décrit la relativité générale s'effondre sous les fluctuations quantiques de la gravité : la notion même de distance perd son sens, faute d'une théorie de gravité quantique aboutie pour la décrire.",
  ...
  { expo: -18, val: '~10⁻¹⁸ m', name: 'Quark, boson', meters: '1 × 10⁻¹⁸ m', Icon: QuarkIcon, domain: 'quantum', domainLabel: 'Quantique',
    desc: "Limite de résolution des accélérateurs actuels comme le LHC. À cette échelle, les quarks et les bosons se comportent comme des points sans dimension mesurable : aucune expérience n'a jamais détecté de structure interne à ces particules, considérées comme élémentaires par le Modèle standard.",
    href: '/atoms/particules', hrefLabel: 'Voir les particules élémentaires' },
  { expo: -15, val: '~1 fm', name: 'Proton, noyau atomique', meters: '1 × 10⁻¹⁵ m', Icon: NucleusIcon, domain: 'quantum', domainLabel: 'Quantique',
    desc: "Le noyau atomique concentre 99,9 % de la masse de l'atome dans un volume cent mille fois plus petit que l'atome lui-même. S'il était gonflé à la taille d'un ballon de football, l'atome entier occuperait le volume d'une ville entière.",
  ...
  { expo: -10, val: '~1 Å', name: "Atome d'hydrogène", meters: '1 × 10⁻¹⁰ m', Icon: AtomIcon, domain: 'atomic', domainLabel: 'Atomique',
    desc: "Le nuage électronique définit la taille de l'atome, un dixième de nanomètre, l'unité de base de toute matière ordinaire. Environ deux millions d'atomes d'hydrogène alignés tiendraient sur l'épaisseur d'un cheveu humain.",
  ...
  { expo: -9, val: '~2 nm', name: "Double hélice d'ADN", meters: '2 × 10⁻⁹ m', Icon: DnaIcon, domain: 'life', domainLabel: 'Vivant',
    desc: "Le diamètre de la molécule qui porte l'information génétique de toute vie sur Terre. Déroulé, l'ADN contenu dans une seule cellule humaine mesurerait environ deux mètres de long, comprimé dans un noyau de quelques micromètres.",
  ...
  { expo: -7, val: '~100 nm', name: 'Virus', meters: '1 × 10⁻⁷ m', Icon: VirusIcon, domain: 'life', domainLabel: 'Vivant',
    desc: "À la frontière entre chimie et biologie, trop petit pour être vu au microscope optique classique, dont la limite de résolution avoisine les 200 nanomètres. Il faut un microscope électronique pour observer directement un virus.",
  ...
  { expo: -5, val: '~10 µm', name: 'Cellule humaine', meters: '1 × 10⁻⁵ m', Icon: CellIcon, domain: 'life', domainLabel: 'Vivant',
    desc: "Le corps humain compte environ 37 000 milliards de cellules de cette taille typique. Mises bout à bout, elles couvriraient une distance de plusieurs fois l'aller-retour Terre-Lune.",
  ...
  { expo: -3, val: '~5 mm', name: 'Fourmi', meters: '5 × 10⁻³ m', Icon: AntIcon, domain: 'human', domainLabel: 'Humain',
    desc: "À cette échelle, la vie devient visible à l'œil nu, le seuil de notre perception directe du monde. En dessous, il faut un instrument grossissant ; au-dessus commence tout ce que nos sens peuvent explorer sans aide.",
    href: '/biologie/vivant', hrefLabel: 'Voir le vivant' },
  { expo: 0, val: '~1,7 m', name: 'Être humain', meters: '1,7 m', Icon: HumanIcon, domain: 'human', domainLabel: 'Humain',
    desc: "L'échelle de référence, le point zéro à partir duquel toutes les autres échelles de cette page se mesurent par comparaison. C'est aussi l'échelle à laquelle l'intuition physique humaine fonctionne le mieux, avant de s'effondrer aux deux extrêmes.",
  ...
  { expo: 4, val: '~8,8 km', name: 'Everest', meters: '8 849 m', Icon: MountainIcon, domain: 'human', domainLabel: 'Humain',
    desc: "Le plus haut sommet terrestre, même s'il fait pâle figure devant le Mont Olympus sur Mars avec ses 22 kilomètres de haut environ, soit près de deux fois et demie la hauteur de l'Everest, porté par une gravité martienne trois fois plus faible.",
  ...
  { expo: 7, val: '~12 742 km', name: 'Diamètre de la Terre', meters: '1,27 × 10⁷ m', Icon: EarthIcon, domain: 'planet', domainLabel: 'Planétaire',
    desc: "12 742 kilomètres, soit un peu plus de quatre fois celui de la Lune. C'est la plus grande des planètes rocheuses du système solaire, juste devant Vénus, et la seule connue à abriter la vie.",
    href: '/space/bodys', hrefLabel: 'Voir les corps du système solaire' },
  { expo: 13, val: '~1 UA', name: 'Distance Terre-Soleil', meters: '1,5 × 10¹¹ m', Icon: SunIcon, domain: 'planet', domainLabel: 'Planétaire',
    desc: "150 millions de kilomètres, l'unité astronomique. La lumière du Soleil met 8 minutes et 20 secondes à nous atteindre : ce que nous voyons de notre étoile date toujours de plusieurs minutes.",
  ...
  { expo: 16, val: '~1 année-lumière', name: 'Année-lumière', meters: '9,46 × 10¹⁵ m', Icon: LightRayIcon, domain: 'cosmic', domainLabel: 'Cosmique',
    desc: "La distance parcourue par la lumière en une année, soit près de 9 500 milliards de kilomètres. L'étoile la plus proche du Soleil, Proxima du Centaure, est à 4,2 années-lumière : sa lumière actuelle a quitté l'étoile il y a plus de quatre ans.",
  ...
  { expo: 21, val: '~100 000 al', name: 'Voie lactée', meters: '9,5 × 10²⁰ m', Icon: GalaxyDiskIcon, domain: 'cosmic', domainLabel: 'Cosmique',
    desc: "Notre galaxie compte entre 100 et 400 milliards d'étoiles réparties sur un disque spiral de 100 000 années-lumière de diamètre. Le Soleil met environ 230 millions d'années à en faire le tour complet.",
  ...
  { expo: 24, val: '~500 millions al', name: 'Superamas de Laniakea', meters: '4,7 × 10²⁴ m', Icon: SuperclusterIcon, domain: 'cosmic', domainLabel: 'Cosmique',
    desc: "Le superamas qui abrite la Voie lactée regroupe environ 100 000 galaxies sur 520 millions d'années-lumière. Son nom hawaïen, découvert en 2014, signifie « horizon céleste immense ».",
    href: '/space/galaxies', hrefLabel: 'Voir les galaxies' },
  { expo: 26, val: '~8,8 × 10²⁶ m', name: 'Univers observable', meters: '8,8 × 10²⁶ m', Icon: UniverseIcon, domain: 'cosmic', domainLabel: 'Cosmique',
    desc: "93 milliards d'années-lumière de diamètre, la limite de ce que la lumière a eu le temps de nous apporter depuis le Big Bang, il y a 13,8 milliards d'années. Au-delà de cet horizon, l'univers continue probablement, mais sa lumière ne nous est jamais parvenue.",
