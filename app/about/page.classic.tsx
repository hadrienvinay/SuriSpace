// app/about/page.classic.tsx — SAUVEGARDE de l'ancienne page About (hero photo + timeline classique).
// Fichier inerte : Next.js ne route que app/about/page.tsx exact, donc ceci n'est pas une route active.
// Pour restaurer : `cp app/about/page.classic.tsx app/about/page.tsx`.
'use client';
