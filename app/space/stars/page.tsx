      ...
      <div className="max-w-screen-2xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-3 text-[16px] text-gray-600 font-mono mb-6">
          ...
          <div className="flex gap-2 w-full sm:w-auto sm:ml-auto">
            <Link href="/space/stars/constellations" className="flex-1 sm:flex-none text-center px-3 py-1.5 rounded-lg text-md border border-white/10 text-gray-400 hover:text-white hover:bg-white/5 transition-all">
              Constellations
            </Link>
            <Link href="/space/stars/star" className="flex-1 sm:flex-none text-center px-3 py-1.5 rounded-lg text-md border border-white/10 text-gray-400 hover:text-white hover:bg-white/5 transition-all">
              Catalogue d&apos;étoiles
            </Link>
          </div>
        </div>
            ...
            <div className="xl:sticky xl:top-20 space-y-4 w-full">
              ...
              {selectedStar && (
                <div className="rounded-2xl border overflow-hidden"
                  ...
                  <div className="px-5 pb-5">
                    <Link href={`/space/stars/star/${selectedStar.id}`}
              ...
              {selectedConstellation && !selectedStar && (
                <div className="rounded-2xl border p-5"
                  ...
                  <Link href={`/space/stars/constellations/${selectedConstellation.id}`}
                    className="block text-center py-2.5 rounded-xl text-sm font-bold uppercase tracking-wide transition-all hover:brightness-110"
                    style={{
              ...
              {!selectedStar && !selectedConstellation && (
                <div className="rounded-2xl border border-white/8 p-5" style={{ background: 'rgba(255,255,255,0.02)' }}>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2 pt-4 border-t border-white/8">
                    <Link href="/space/stars/star" className="text-center py-2.5 rounded-xl text-sm font-semibold border border-white/10 text-gray-400 hover:text-white hover:bg-white/5 transition-all">
                      Toutes les étoiles
                    </Link>
                    <Link href="/space/stars/constellations" className="inline-flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-sm font-semibold border border-white/10 text-gray-400 hover:text-white hover:bg-white/5 transition-all">
