      ...
      <SolarLayout>
        <div className="min-h-screen bg-[#01040e] text-white flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/space/stars" className="text-blue-400 underline mt-3 block">Retour à la carte</Link>
          </div>
        </div>
      </SolarLayout>
    );
    ...
    <div className="min-h-screen text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>
      ...
      <div className="max-w-4xl mx-auto px-5 py-10">
        ...
        <div className="flex items-center gap-2 text-[16px] text-gray-600 font-mono mb-6">
          ...
          <span>›</span>
          <Link href="/space/stars" className="hover:text-white transition-colors">Étoiles</Link>
          <span>›</span>
          <Link href="/space/stars/star" className="hover:text-white transition-colors">Catalogue</Link>
          {constellation && (
            <>
              <span>›</span>
              <Link href={`/space/stars/constellations/${constellation.id}`} className="hover:text-white transition-colors" style={{ color: constellation.color }}>
        ...
        <div className="relative rounded-3xl border overflow-hidden mb-8 p-8 sm:p-10"
          ...
          <div className="relative">
            <div className="flex items-center gap-2 mb-3 flex-wrap">
              ...
              {constellation && (
                <Link href={`/space/stars/constellations/${constellation.id}`}
        ...
        <div className="flex justify-between items-center pt-4 border-t border-white/8">
          {prev ? (
            <Link href={`/space/stars/star/${prev.id}`}
          ...
          <Link href="/space/stars" className="text-md text-gray-600 hover:text-white font-mono transition-colors">
            Carte du ciel →
          </Link>

          {next ? (
            <Link href={`/space/stars/star/${next.id}`}
