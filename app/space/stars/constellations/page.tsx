    ...
    <div style={{ minHeight: '100vh', color: '#e8eaf6', fontFamily: "'Exo 2', sans-serif" }}>
      ...
      <div style={{ padding: '40px 40px 0', maxWidth: 1400, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 20, marginBottom: 36 }}>
          ...
          <Link href="/space/stars/star" style={{
            padding: '8px 18px',
            borderRadius: 10,
            border: '1px solid rgba(255,255,255,0.12)',
            color: 'rgba(255,255,255,0.6)',
      ...
      <div style={{ padding: '0 40px 80px', maxWidth: 1400, margin: '0 auto' }}>
        <div style={{
          ...
          {filtered.map((c, idx) => {
            ...
            return (
              <Link key={c.id} href={`/space/stars/constellations/${c.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                <div
            ...
            return (
              <div key={key} style={{
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
                  {list.map(c => (
                    <Link key={c.id} href={`/space/stars/constellations/${c.id}`} style={{
                      fontSize: 13,
                      color: 'rgba(255,255,255,0.5)',
                      textDecoration: 'none',
                      padding: '2px 6px',
