    ...
    <div className="min-h-screen text-white" style={{ fontFamily: "'Exo 2', sans-serif" }}>
      ...
      <div className="max-w-5xl mx-auto px-5 py-10">
        ...
        <div className="flex items-center gap-2 text-[16px] text-gray-600 font-mono mb-6">
          ...
          <span>›</span>
          <Link href="/space/stars/constellations" className="hover:text-white transition-colors">Constellations</Link>
          <span>›</span>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {constellationStars.map(star => {
                ...
                return (
                  <Link key={star.id} href={`/space/stars/star/${star.id}`}
        ...
        <div className="flex justify-between items-center pt-4 border-t border-white/8">
          {prev ? (
            <Link href={`/space/stars/constellations/${prev.id}`}
          ...
          <Link href="/space/stars" className="text-sm text-gray-600 hover:text-white transition-colors font-mono">✨ Carte</Link>
          {next ? (
            <Link href={`/space/stars/constellations/${next.id}`}
