      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <a href="/space/astronomie/ciel"className="text-md font-bold tracking-widest uppercase text-purple-500">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <Link
              href="/space/astronomie/instruments"
