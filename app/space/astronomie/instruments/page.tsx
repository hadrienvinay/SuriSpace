...
const INSTRUMENTS: Instrument[] = [
  ...
  },
  {
    ...
    launched: '2013',
    location: 'Point de Lagrange L2 (1,5 M km)',
    aperture: '2 × 0,7 m (deux télescopes)',
    wavelength: 'Visible (330 – 1050 nm)',
    color: '#818CF8',
    gradient: 'linear-gradient(135deg, #312e81, #4338ca)',
    photoUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Gaia_spacecraft.jpg',
    status: 'actif',
    headline: 'La carte 3D d\'un milliard d\'étoiles',
    description: 'Gaia mesure simultanément la position, la distance et le mouvement propre de ~1,7 milliard d\'étoiles de la Voie Lactée avec une précision de quelques microarcseccondes — comparable à détecter une pièce de monnaie sur la Lune depuis la Terre. Ses catalogues transforment la galactographie moderne.',
    discoveries: [
      'Parallaxes et vitesses propres de 1,7 milliard d\'étoiles (Gaia DR3, 2022)',
      'Gaia-Sausage-Enceladus : relique d\'une galaxie fusionnée il y a 8–11 Ga',
      '500 000 quasars et 160 000 astéroïdes du système solaire catalogués',
      'Candidate ondes gravitationnelles fond de trous noirs supermassifs (Gaia DR4)',
      'Carte de la matière noire galactique via les vitesses stellaires',
    ],
  },
  {
    id: 'euclid',
    ...
    location: 'Point de Lagrange L2 (1,5 M km)',
    aperture: '1,2 m',
    wavelength: 'Visible · Infrarouge proche',
    color: '#22D3EE',
    gradient: 'linear-gradient(135deg, #164e63, #0891b2)',
    photoUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Euclid_spacecraft_model.jpg',
    status: 'actif',
    headline: 'Cartographier l\'Univers sombre sur 15 000 deg²',
    description: 'Euclid a été lancé en juillet 2023 pour cartographier la géométrie de l\'Univers sombre sur 1/3 du ciel jusqu\'à z≈2, couvrant 10 milliards de galaxies. En mesurant le cisaillement gravitationnel et les oscillations acoustiques de baryons (BAO), il vise à comprendre nature de l\'énergie noire et de la matière noire.',
    discoveries: [
      'Premières images : amas de Persée, Nébuleuse de la Tête de Cheval, NGC 6744 (nov. 2023)',
      'Cartographie du cisaillement gravitationnel (lensing faible) à grande échelle',
      'Profil des halos de matière noire autour des galaxies et amas',
      'Contraintes sur l\'équation d\'état de l\'énergie noire w(z)',
      'Galaxies naines à bas redshift détectées par milliers dans les premières données',
    ],
  },
  {
    id: 'kepler',
    name: 'Télescope Kepler',
    shortName: 'Kepler',
    category: 'spatial',
    country: 'NASA',
    launched: '2009',
    location: 'Orbite héliocentrique (retraité 2018)',
    aperture: '0,95 m',
    wavelength: 'Visible (430 – 890 nm)',
    color: '#FB923C',
    gradient: 'linear-gradient(135deg, #7c2d12, #c2410c)',
    photoUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Kepler_Space_Telescope.jpg',
    status: 'inactif',
    headline: 'Le chasseur d\'exoplanètes qui a tout changé',
    description: 'Kepler a fixé un unique champ de 150 000 étoiles pendant 4 ans, cherchant les micro-baisses de luminosité révélatrices d\'un transit planétaire. Après une panne de gyroscope, la mission K2 a été créée, utilisant la pression de radiation du Soleil comme troisième stabilisateur. Mis à la retraite en 2018 faute de carburant.',
    discoveries: [
      '2 718 exoplanètes confirmées — la moitié du catalogue total connu à son époque',
      'Kepler-22b, Kepler-452b : parmi les premières planètes rocheuses en zone habitable',
      'Systèmes multi-planétaires compacts (Kepler-11 : 6 planètes en orbite rapprochée)',
      'Occurrence des planètes : 1 étoile sur 5 possède une planète de taille terrestre',
      'Étoile de Tabby (KIC 8462852) : variations inexpliquées toujours étudiées',
    ],
  },
  {
    id: 'xmm',
    ...
    country: 'ESA',
    launched: '1999',
    location: 'Orbite elliptique haute (~114 000 km)',
    aperture: '3 × 0,7 m (incidence rasante)',
    wavelength: 'Rayons X (0,1 – 15 keV)',
    color: '#F472B6',
    gradient: 'linear-gradient(135deg, #701a75, #a21caf)',
    photoUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/XMM-Newton_spacecraft_model.jpg',
    status: 'actif',
    headline: 'La plus grande surface collectrice de rayons X',
    description: 'XMM-Newton (X-ray Multi-Mirror Mission) est le plus grand télescope X spatial en termes de surface collectrice. Ses trois télescopes à incidence rasante et son spectrographe optique simultané permettent d\'étudier les sources X les plus faibles : noyaux actifs de galaxies, étoiles à neutrons, restes de supernovae.',
    discoveries: [
      'Catalogue 4XMM-DR13 : 939 000 sources X, la plus grande carte X du ciel',
      'Gaz chaud inter-amas cartographié dans des filaments cosmiques (WHIM)',
      'Oscillations quasi-périodiques autour de trous noirs en accrétion',
      'Écho X de Sgr A* : lumière réfléchie par des nuages moléculaires du centre galactique',
      'Naines blanches, étoiles de neutrons et sursauts X de galaxies lointaines',
    ],
  },
  {
    id: 'planck',
    ...
    country: 'ESA',
    launched: '2009',
    location: 'L2 — désorbité 2013',
    aperture: '1,9 × 1,5 m',
    wavelength: 'Micro-ondes (0,35 – 10 mm)',
    color: '#6EE7B7',
    gradient: 'linear-gradient(135deg, #064e3b, #0f766e)',
    photoUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Planck_satellite.jpg',
    status: 'inactif',
    headline: 'La carte la plus précise du fond diffus cosmologique',
    description: 'Planck a cartographié les fluctuations de température du fond diffus cosmologique (CMB) à une précision sans précédent. Ce rayonnement fossile, émis 380 000 ans après le Big Bang, encode toute l\'histoire de l\'Univers. Les données Planck constituent la référence de la cosmologie de précision.',
    discoveries: [
      'Âge de l\'Univers : 13,82 milliards d\'années (précision 0,1%)',
      'Composition : 4,9% matière ordinaire · 26,8% matière noire · 68,3% énergie noire',
      'Premières étoiles (réionisation) : ~380 millions d\'années après le Big Bang',
      'Modes B de polarisation : contraintes sur l\'inflation cosmique primordiale',
      'Anomalie de la tension de Hubble (H₀ : Planck vs observations directes)',
    ],
  },
  /* ── Terrestres ───────────────────────────────────────── */
  {
    ...
    <SolarLayout>
      <div className="max-w-screen-xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 text-[16px] text-gray-600 font-mono mb-6">
          ...
          <span>›</span>
          <Link href="/space/astronomie" className="hover:text-white transition-colors">Astronomie</Link>
          <span>›</span>
