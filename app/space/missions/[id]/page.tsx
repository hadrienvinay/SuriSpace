...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `/space/missions/${id}` },
  };
}
      ...
      <SolarLayout>
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <Link href="/space/missions" className="text-blue-400 underline mt-3 block text-base">
    ...
    <SolarLayout>
      <div className="max-w-4xl mx-auto px-5 py-10">
        ...
        <div className="flex items-center gap-2 text-[16px] text-gray-600 font-mono mb-6">
          ...
          <span>›</span>
          <Link href="/space/missions" className="hover:text-white transition-colors">Missions</Link>
          <span>›</span>
          ...
          <div className="rounded-2xl border border-white/8 p-5 bg-white/2">
            ...
            <div className="space-y-2.5">
              {targetBodies.map(tb => tb && (
                <Link key={tb.id} href={`/space/bodys/${tb.id}`}
        ...
        <div className="flex justify-between items-center pt-4 border-t border-white/8">
          {prevMission ? (
            <Link href={`/space/missions/${prevMission.id}`}
          ...
          {nextMission ? (
            <Link href={`/space/missions/${nextMission.id}`}
