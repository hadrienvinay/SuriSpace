  ...
  return (
   <div className="min-h-screen bg-linear-to-br from-pink-100 to-blue-100 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden text-black">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        <div className="absolute top-10 right-10 text-pink-200 animate-pulse">🌟</div>
        ...
        <div className="absolute bottom-1/3 right-10 text-pink-200 animate-pulse">💕</div>
        ...
        <div className="absolute bottom-1/3 left-10 text-pink-200 animate-pulse">💕</div>
      </div>
