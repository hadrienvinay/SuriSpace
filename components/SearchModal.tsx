...
const INDEX: Result[] = [
  ...
  // Sections
  { href: '/solar-system',       title: 'Espace',        desc: 'Système solaire, galaxies, missions, étoiles.', category: 'Section', color: '#60A5FA' },
  { href: '/solar-system/carte', title: 'Carte du système solaire', desc: 'Carte interactive en échelle logarithmique.', category: 'Espace', color: '#60A5FA' },
  { href: '/solar-system/bodys', title: 'Corps célestes', desc: 'Planètes, lunes et naines du système solaire.', category: 'Espace', color: '#60A5FA' },
  { href: '/solar-system/missions', title: 'Missions & Sondes', desc: 'Apollo, Voyager, JWST, Artemis…', category: 'Espace', color: '#60A5FA' },
  { href: '/solar-system/galaxies', title: 'Galaxies', desc: 'Voie Lactée, Andromède, 15 galaxies remarquables.', category: 'Espace', color: '#60A5FA' },
  { href: '/solar-system/astronomie', title: 'Astronomie', desc: 'Histoire, instruments, catalogue Messier.', category: 'Espace', color: '#60A5FA' },
  { href: '/solar-system/stars', title: 'Carte du ciel', desc: 'Étoiles et constellations visibles.', category: 'Espace', color: '#60A5FA' },
