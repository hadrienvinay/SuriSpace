...
const DROPDOWNS: { label: string; Icon: TopIcon; color: string; items: NavItem[] }[] = [
  {
    ...
    color: '#60A5FA',
    items: [
      { href: '/space',            label: 'Accueil',          Icon: IcoHome      },
      { href: '/space/carte',      label: 'Carte interactive', Icon: IcoMap      },
      { href: '/space/bodys',      label: 'Corps célestes',   Icon: IcoGlobe     },
      { href: '/space/galaxies',   label: 'Galaxies',         Icon: IcoGalaxy    },
      { href: '/space/missions',   label: 'Missions & Sondes',Icon: IcoRocket    },
      { href: '/space/astronomie', label: 'Astronomie',       Icon: IcoTelescope },
      { href: '/space/stars',        label: 'Carte du ciel',    Icon: IcoStar       },
      { href: '/space/exoplanetes', label: 'Exoplanètes',      Icon: IcoExoplanet  },
    ],
  },
  {
    label: 'Sciences',
